...
"zone"};
    ...
    'm', 'u', 'v', 'w', 'x', 
    'y', 'z', };
    public static readonly char[] allRussianChars = { 
    'а','б','в','г','д',
    'е','ё','ж','з','и',
    'й','к','л','м','н',
    'о','п','р','с','т',
